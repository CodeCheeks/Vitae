        ...
        <div className="container">
            <div className="row justify-content-center">
                ...
                <NavLink className='link__style logo__wrapper'to="/area-personal/actividades">
                    <img src="https://res.cloudinary.com/dv7hswrot/image/upload/v1620034588/Vitae/iconos/work-time_tzuquc.png" className="figure-img img-fluid rounded icon__img" width="1280" alt="A generic square placeholder."/>
                    <div>Actividades</div>
                </NavLink>
                </div>
                <div className="col-6 col-md-4 text-center my-3">
